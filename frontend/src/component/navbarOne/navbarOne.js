...
import Tw from "../../assets/images/tweet-logo.png";
    ...
    <>
      <Navbar bg="success" expand="lg">
        ...
        <Navbar.Collapse className="justify-content-end">
          <Nav className="mr-auto">
            <Nav.Link
              style={{ color: "white", fontSize: 15, marginLeft: 5 }}
              href="/"
            >
      ...
      <ListGroup horizontal>
        <ListGroup.Item
          action
          href="/news/"
          className="rounded-0 md-4 text-center"
          style={{ backgroundColor: "black" }}
        >
          <img
            style={{ height: 35, width: 30 }}
            src="https://www.tenforums.com/geek/gars/images/2/types/thumb_news_and_interests.png"
            alt=""
          />
        </ListGroup.Item>
        <ListGroup.Item
        ...
        >
          <img style={{ height: 30, width: 30 }} src={Tw} alt="" />
        </ListGroup.Item>
        <ListGroup.Item
          action
          href="/reddit/"
          className="rounded-0 md-4 text-center"
          style={{ backgroundColor: "#FF3F18" }}
        >
          <img
            style={{ height: 30, width: 30 }}
            src="https://www.sportico.com/wp-content/uploads/2019/10/reddit-1.png"
            alt=""
          />
        </ListGroup.Item>
      </ListGroup>
